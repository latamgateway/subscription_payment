...
module SubscriptionPaymentApi
  module Providers
    module Braintree
      class CreditCard < SubscriptionPaymentApi::Providers::Braintree::Base
        extend T::Sig

        sig do
          params(
            token: String
          ).returns(SubscriptionPaymentApi::Entity::CreditCard)
        end
        def find(token:)
        ...
        sig do
          params(
            credit_card: SubscriptionPaymentApi::Entity::CreditCard
          ).returns(SubscriptionPaymentApi::Entity::CreditCard)
        end
